> **Internal use note:** This is the audit engine behind the "SEO & Online Visibility"
> service on [The AI Syndicate](../index.html). Run `/seo audit <client-url>` during
> or before a session to generate the client's action plan and report.
