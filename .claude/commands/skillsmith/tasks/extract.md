...
<references>
@../../../skillsmith-specs/entry-point.md (for skill structure decisions)
@../../../skillsmith-specs/tasks.md (for task file output format)
@../../../skillsmith-specs/frameworks.md (for framework file output format)
